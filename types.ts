...
export interface GeminiAnalysisResult {
  // Nuevas propiedades para el formato professional
  ...
  analisis_wyckoff?: {
    fase?: string;
    descripcion?: string;
    puntos_clave?: Array<{ nivel: string; descripcion: string }>;
    contexto_fase?: string;
  };
  analisis_smart_money?: {
    order_blocks?: Array<{ tipo: string; nivel: number; descripcion: string }>;
    liquidity_levels?: Array<{ tipo: string; nivel: number; descripcion: string }>;
  };
...
// Data source types
export type DataSource = 'binance' | 'bingx' | 'twelvedata' | 'alphavantage' | 'yfinance';
